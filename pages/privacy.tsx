...
const Home: NextPage = () => {
  return (
    <>
      ...
      <p>
        Oskars Ezerins built the Quotes Bytes app as a Free app. This SERVICE is provided by Oskars Ezerins at no cost
      ...
      <p>
        ...
        accessible at Quotes Bytes unless otherwise defined in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        identifiable information, including but not limited to Oskars Ezerins. The information that I request will be
      ...
      <p>
        ...
        sent to your browser from the websites that you visit and are stored on your device internal memory.
      </p>{' '}
      <p>
      ...
      <p>This policy is effective as of 2024-03-03</p>{' '}
      <p>
